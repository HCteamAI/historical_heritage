...
SC_AGENT_IMPLEMENTATION(FilterLiterature)
{
  if (!edgeAddr.IsValid())
    {
  ...
  ScAddr begin = ms_context->HelperFindBySystemIdtf("subject_domain_of_belarusian_literature");
