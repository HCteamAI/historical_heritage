...
#include "FilterMonumentalArt.hpp"
...
SC_AGENT_IMPLEMENTATION(FilterMonumentalArt)
{
  if (!edgeAddr.IsValid())
    {
  ...
  ScAddr rrel = ms_context->HelperFindBySystemIdtf("rrel_not_maximum_studied_object_class");
  ScAddr begin = ms_context->HelperFindBySystemIdtf("subject_domain_of_monumental_art_of_Belarus");
